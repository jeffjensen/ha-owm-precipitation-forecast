...
# Sets up and tears down the integration
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    _LOGGER.debug("Setting up OWM Precipitation Forecast integration")
    ...
    _LOGGER.info("OWM Precipitation Forecast integration setup complete")
    return True


async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    """Unload a config entry."""
    _LOGGER.debug("Unloading OWM Precipitation Forecast integration")
