...
async def test_coordinator_initialization(hass, config_data, mock_owm_response):
    ...
    with patch("custom_components.ha_owm_precipitation_forecast.coordinator.OWMWeatherService"):
...
async def test_coordinator_data_update(hass, config_data, mock_owm_response):
    ...
    with patch(
        ...
        with patch.object(coordinator.weather_service, "async_get_forecast", mock_service.async_get_forecast):
